...
contract undefined_7 {
    ...
    constructor() public payable {
        EffectiveTime = 1392739200;
        CloseTime = 1000;
        OutSideClosingDate = 1419955200;
        sellerName = "David Paulson";
        seller = address(0);
        buyerName =["ROCKVILLE FINANCIAL, INC."];
        buyer =[address(0)];
    }
