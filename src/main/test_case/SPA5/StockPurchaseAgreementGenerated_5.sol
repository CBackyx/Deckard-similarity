...
contract StockPurchaseAgreementTemplate {
    ...
    uint[0] public pricePayedByBuyer;
    bool[0] public purchaseSellerConfirmed;
    bool[0] public purchaseBuyerConfirmed;
    mapping(string => uint32) fileHashMap;
    bool[0] public terminateSellerConfirmed;
    bool[0] public terminateBuyerConfirmed;
    enum State {
        Created, Locked, Release, Transfered, Inactive }
    State[0] public state;
